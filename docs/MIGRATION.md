...
| … | … | Xem [`ARCHITECTURE.md`](ARCHITECTURE.md), [`spec-pack/01-SYSTEM-SPEC.md`](spec-pack/01-SYSTEM-SPEC.md) |
...
Chi tiết: [`DOCKER-COMPOSE.md`](DOCKER-COMPOSE.md), [`README.md`](../README.md).
