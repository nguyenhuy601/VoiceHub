...
const MODULES = Object.freeze([
  ...
  { key: 'organization.skill_registry', categoryKey: 'organization', label: 'Skill Registry' },
...
const MASTER_PERMISSIONS = Object.freeze([
  ...
  'organization.skill_registry.view',
  'organization.skill_registry.review',
...
const MASTER_TO_LEGACY_ENTRIES = Object.freeze({
  ...
  'organization.skill_registry.view': { resource: 'skill_registry', actions: ['view'] },
  'organization.skill_registry.review': { resource: 'skill_registry', actions: ['review'] },
