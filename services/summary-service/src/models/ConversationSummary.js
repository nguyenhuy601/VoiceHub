...
conversationSummarySchema.index({ threadKey: 1, 'sourceMeta.lastMessageId': 1, status: 1 });
conversationSummarySchema.index({ generatedBy: 1, createdAt: -1 });
conversationSummarySchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
