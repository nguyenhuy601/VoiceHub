/**
 * Org-level WorkflowTemplate seeds — Startup vs Enterprise (Phase 4).
...
const ENTERPRISE_TEMPLATE = Object.freeze({
  ...
  transitions: [
    ...
    { fromKey: 'uat', toKey: 'deploy', name: 'Approve UAT', conditions: ['priority_not_urgent_or_ok'] },
    { fromKey: 'deploy', toKey: 'done', name: 'Deployed', validators: ['assignee_present'], requiresApprovalPolicyKey: 'task_done' },
...
const BUILTIN_TEMPLATES = Object.freeze([STARTUP_TEMPLATE, ENTERPRISE_TEMPLATE, DEFAULT_BOARD_TEMPLATE]);
