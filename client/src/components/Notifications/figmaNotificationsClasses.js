...
export const FIGMA_NOTIF_INNER = 'mx-auto w-full max-w-[760px] px-6 py-5';
...
export const FIGMA_NOTIF_ITEM =
  'flex gap-3 rounded-xl border border-border bg-surface p-4 transition-[box-shadow,border-color,transform] duration-150 hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-md';

export const FIGMA_NOTIF_ITEM_UNREAD = 'border-l-4 border-l-primary';
