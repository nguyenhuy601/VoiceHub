...
export const extraStrings = {
  vi: {
    ...
    settingsCapability: {
      ...
      toastSubmitted: 'Đã nộp hồ sơ — chờ HR duyệt.',
      submitIncomplete: 'Cần chuyên môn, năm kinh nghiệm và ít nhất 1 kỹ năng để nộp.',
      submitNeedJobTitle:
        'Chưa có vị trí công ty (Position) — nhờ HR/Admin gán trước khi nộp.',
      pendingHint: 'Đang chờ HR xác minh.',
      rejectLabel: 'Lý do từ chối',
      position: 'Vị trí công ty (Position)',
      jobTitleEmpty: 'Chưa gán — liên hệ HR/Admin',
      jobTitleHint:
        'Position do HR/Admin gán (Admin → Position). Không đổi tại form năng lực.',
      domain: 'Chuyên môn chính',
      years: 'Số năm kinh nghiệm',
      skills: 'Kỹ năng',
      addSkill: 'Thêm',
      addSkillPlaceholder: 'Chọn kỹ năng…',
      level: 'Mức',
      maxSkills: 'Tối đa {n} kỹ năng.',
      availability: 'Mức độ sẵn sàng',
      summary: 'Tóm tắt ngắn',
      summaryPlaceholder: 'Ví dụ: Backend Node/Mongo, từng làm hệ thống realtime…',
      ...
      availabilityOptions: {
        ...
        busy: 'Đang bận',
        partial: 'Nhận việc hạn chế',
      },
      cvUploadTitle: 'Upload CV (PDF)',
      cvUploadHint:
        'Hệ thống đọc PDF và gợi ý điền form. Bạn phải kiểm tra rồi nộp HR — không tự xác minh.',
      cvUploadBtn: 'Chọn file PDF',
      cvUploading: 'Đang đọc CV…',
      cvFileLabel: 'File đã tải',
      cvPdfOnly: 'Chỉ chấp nhận file PDF.',
      cvTooLarge: 'File tối đa 5MB.',
      ...
      businessDomains: 'Lĩnh vực nghiệp vụ',
      addDomain: 'Thêm lĩnh vực',
      addDomainPlaceholder: 'Chọn lĩnh vực…',
      certifications: 'Chứng chỉ',
      certName: 'Tên chứng chỉ',
      certIssuer: 'Tổ chức cấp',
      addCert: 'Thêm chứng chỉ',
      maxTopSkills: 'Tối đa {n} kỹ năng thành thạo nhất (thứ tự = mức thành thạo).',
    },
    settingsOverview: {
      title: 'Tổng quan hồ sơ',
      subtitle: 'Thông tin công ty, thông số capacity và hoạt động trên các dự án đang tham gia.',
      editCapability: 'Sửa năng lực',
      noOrg: 'Bạn chưa thuộc tổ chức — một số thông số capacity chưa có.',
      erpForbidden: 'Không xem được hồ sơ nguồn lực tổ chức (thiếu quyền).',
      ...
      workingHours: 'Capacity tháng',
      allocated: 'Đã phân bổ',
      available: 'Còn trống',
      projects: 'Dự án',
      noAllocations: 'Chưa được phân bổ vào dự án.',
      colProject: 'Dự án',
      colRole: 'Vai trò',
      colPct: 'Allocation %',
      colHours: 'Giờ/tháng',
      activity: 'Hoạt động doanh nghiệp',
      activityEmpty: 'Chưa có hoạt động trên các dự án đang tham gia.',
      activityItem: 'Hoạt động',
    },
  },
  en: {
    common: {
    ...
    settingsCapability: {
      ...
      toastSubmitted: 'Submitted — waiting for HR review.',
      submitIncomplete: 'Domain, years of experience, and at least one skill are required to submit.',
      submitNeedJobTitle:
        'No company Position (job title) yet — ask HR/Admin to assign it before submitting.',
      pendingHint: 'Waiting for HR verification.',
      rejectLabel: 'Rejection reason',
      position: 'Company position',
      jobTitleEmpty: 'Not assigned — contact HR/Admin',
      jobTitleHint:
        'Position is set by HR/Admin (Admin → Position). Not editable on this form.',
      domain: 'Primary domain',
      years: 'Years of experience',
      skills: 'Skills',
      addSkill: 'Add',
      addSkillPlaceholder: 'Select a skill…',
      level: 'Level',
      maxSkills: 'Maximum {n} skills.',
      availability: 'Availability',
      summary: 'Short summary',
      summaryPlaceholder: 'e.g. Backend Node/Mongo, realtime systems…',
      selectPlaceholder: '— Select —',
      saveDraft: 'Save draft',
      submit: 'Submit for HR review',
      status: {
        draft: 'Draft',
      ...
      cvUploadTitle: 'Upload CV (PDF)',
      cvUploadHint:
        'We parse the PDF and suggest form fields. You must review and submit for HR — never auto-verified.',
      cvUploadBtn: 'Choose PDF',
      cvUploading: 'Reading CV…',
      cvFileLabel: 'Uploaded file',
      cvPdfOnly: 'PDF files only.',
      cvTooLarge: 'Max file size is 5MB.',
      ...
      addDomainPlaceholder: 'Select a domain…',
      certifications: 'Certifications',
      certName: 'Certificate name',
      certIssuer: 'Issuer',
      addCert: 'Add certificate',
      maxTopSkills: 'Up to {n} strongest skills (order = proficiency).',
    },
    settingsOverview: {
      title: 'Profile overview',
      subtitle: 'Company profile, capacity metrics, and activity on projects you belong to.',
      editCapability: 'Edit skills',
      noOrg: 'You are not in an organization yet — capacity metrics are unavailable.',
      erpForbidden: 'Cannot load organization resource profile (insufficient permission).',
      ...
      empty: 'Not set',
      stats: 'Metrics',
      workingHours: 'Monthly capacity',
      allocated: 'Allocated',
      available: 'Available',
      projects: 'Projects',
      noAllocations: 'Not allocated to any project yet.',
      colProject: 'Project',
      colRole: 'Role',
      colPct: 'Allocation %',
      colHours: 'Hours/month',
      activity: 'Company activity',
      activityEmpty: 'No activity on projects you belong to yet.',
