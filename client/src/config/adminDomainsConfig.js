    ...
    sections: [
      {
        id: 'main',
        items: [
          { id: 'list', path: '/app/admin/users', labelKey: 'adminDomains.users.list', end: true, implementation: 'people', requiredGrant: 'organization.employee.view' },
          { id: 'import', path: '/app/admin/users/import', labelKey: 'adminDomains.users.import', implementation: 'users-import-hub', requiredGrant: 'organization.employee.invite' },
          {
            id: 'people-ops',
            path: '/app/admin/users/people-ops',
            labelKey: 'adminDomains.users.peopleOpsHub',
            implementation: 'users-people-ops',
            requiredGrant: 'organization.employee.update',
          },
          {
            id: 'edit',
          ...
          },
          {
            ...
            nav: 'hidden',
            requiredGrant: 'organization.employee.delete',
          },
        ],
      },
    ],
    ...
    sections: [
      {
        id: 'main',
        items: [
          { id: 'list', path: '/app/admin/accounts', labelKey: 'adminDomains.accounts.list', end: true, implementation: 'accounts-list', requiredGrant: 'organization.employee.view' },
          {
            id: 'password-hub',
            path: '/app/admin/accounts/password',
            labelKey: 'adminDomains.accounts.passwordHub',
            implementation: 'accounts-password-hub',
            requiredGrant: 'organization.employee.reset_password',
          },
          {
            id: 'access-hub',
            ...
            requiredGrant: 'organization.employee.disable',
          },
          {
            id: 'verification-hub',
          ...
          },
          {
            ...
            nav: 'hidden',
            requiredGrant: 'organization.employee.view',
          },
          {
            id: 'login-history',
    ...
    sections: [
      {
        ...
        items: [
          { id: 'levels', path: '/app/admin/org-structure/levels', labelKey: 'adminDomains.orgStructure.levels', end: true, implementation: 'org-levels', requiredGrant: 'organization.structure.view' },
          { id: 'unit-tree', path: '/app/admin/org-structure/units', labelKey: 'adminDomains.orgStructure.unitTree', implementation: 'org-unit-tree', requiredGrant: 'organization.structure.view' },
        ],
      },
      {
        id: 'departments',
        ...
        items: [
          { id: 'dept-list', path: '/app/admin/org-structure/departments', labelKey: 'adminDomains.orgStructure.deptList', end: true, implementation: 'org-dept-list', requiredGrant: 'organization.department.view' },
          { id: 'dept-create', path: '/app/admin/org-structure/departments/create', labelKey: 'adminDomains.orgStructure.deptCreate', implementation: 'org-dept-create', requiredGrant: 'organization.department.create' },
          {
            ...
            requiredGrant: 'organization.department.view',
          },
          { id: 'dept-edit', path: '/app/admin/org-structure/departments/edit', labelKey: 'adminDomains.orgStructure.deptEdit', implementation: 'org-dept-edit', nav: 'hidden', requiredGrant: 'organization.department.update' },
          { id: 'dept-disable', path: '/app/admin/org-structure/departments/disable', labelKey: 'adminDomains.orgStructure.deptDisable', implementation: 'org-dept-disable', nav: 'hidden', requiredGrant: 'organization.department.update' },
          { id: 'dept-parent', path: '/app/admin/org-structure/departments/parent', labelKey: 'adminDomains.orgStructure.deptParent', implementation: 'org-dept-parent', nav: 'hidden', requiredGrant: 'organization.department.update' },
          { id: 'dept-head', path: '/app/admin/org-structure/departments/head', labelKey: 'adminDomains.orgStructure.deptHead', implementation: 'org-dept-head', nav: 'hidden', requiredGrant: 'organization.department.update' },
          { id: 'dept-members', path: '/app/admin/org-structure/departments/members', labelKey: 'adminDomains.orgStructure.deptMembers', implementation: 'org-dept-members', nav: 'hidden', requiredGrant: 'organization.department.update' },
          { id: 'dept-org-roles', path: '/app/admin/org-structure/departments/org-roles', labelKey: 'adminDomains.orgStructure.deptOrgRoles', implementation: 'org-dept-org-roles', nav: 'hidden', requiredGrant: 'organization.department.update' },
          { id: 'dept-transfer', path: '/app/admin/org-structure/departments/transfer', labelKey: 'adminDomains.orgStructure.deptTransfer', implementation: 'org-dept-transfer', requiredGrant: 'organization.department.update' },
        ],
      },
      {
        id: 'teams',
        ...
        items: [
          { id: 'team-list', path: '/app/admin/org-structure/teams', labelKey: 'adminDomains.orgStructure.teamList', end: true, implementation: 'org-team-list', requiredGrant: 'organization.team.view' },
          { id: 'team-create', path: '/app/admin/org-structure/teams/create', labelKey: 'adminDomains.orgStructure.teamCreate', implementation: 'org-team-create', requiredGrant: 'organization.team.create' },
          {
            ...
            requiredGrant: 'organization.team.view',
          },
          { id: 'team-edit', path: '/app/admin/org-structure/teams/edit', labelKey: 'adminDomains.orgStructure.teamEdit', implementation: 'org-team-edit', nav: 'hidden', requiredGrant: 'organization.team.update' },
          { id: 'team-archive', path: '/app/admin/org-structure/teams/archive', labelKey: 'adminDomains.orgStructure.teamArchive', implementation: 'org-team-archive', nav: 'hidden', requiredGrant: 'organization.team.update' },
          { id: 'team-members', path: '/app/admin/org-structure/teams/members', labelKey: 'adminDomains.orgStructure.teamMembers', implementation: 'org-team-members', nav: 'hidden', requiredGrant: 'organization.team.update' },
          { id: 'team-leader', path: '/app/admin/org-structure/teams/leader', labelKey: 'adminDomains.orgStructure.teamLeader', implementation: 'org-team-leader', nav: 'hidden', requiredGrant: 'organization.team.update' },
          { id: 'team-dept', path: '/app/admin/org-structure/teams/department', labelKey: 'adminDomains.orgStructure.teamDept', implementation: 'org-team-dept', nav: 'hidden', requiredGrant: 'organization.team.update' },
        ],
      },
      {
        id: 'divisions',
        ...
        items: [
          { id: 'division-list', path: '/app/admin/org-structure/divisions', labelKey: 'adminDomains.orgStructure.divisionList', end: true, implementation: 'org-division-list', requiredGrant: 'organization.division.view' },
          { id: 'division-create', path: '/app/admin/org-structure/divisions/create', labelKey: 'adminDomains.orgStructure.divisionCreate', implementation: 'org-division-create', requiredGrant: 'organization.division.create' },
          {
            id: 'division-manage',
            ...
            requiredGrant: 'organization.division.view',
          },
          { id: 'division-edit', path: '/app/admin/org-structure/divisions/edit', labelKey: 'adminDomains.orgStructure.divisionEdit', implementation: 'org-division-edit', nav: 'hidden', requiredGrant: 'organization.division.update' },
          { id: 'division-disable', path: '/app/admin/org-structure/divisions/disable', labelKey: 'adminDomains.orgStructure.divisionDisable', implementation: 'org-division-disable', nav: 'hidden', requiredGrant: 'organization.division.update' },
          { id: 'division-dept', path: '/app/admin/org-structure/divisions/departments', labelKey: 'adminDomains.orgStructure.divisionDept', implementation: 'org-division-dept', nav: 'hidden', requiredGrant: 'organization.division.update' },
        ],
      },
      {
        id: 'branches',
        ...
        items: [
          { id: 'branch-list', path: '/app/admin/org-structure/branches', labelKey: 'adminDomains.orgStructure.branchList', end: true, implementation: 'org-branch-list', requiredGrant: 'organization.branch.view' },
          { id: 'branch-create', path: '/app/admin/org-structure/branches/create', labelKey: 'adminDomains.orgStructure.branchCreate', implementation: 'org-branch-create', requiredGrant: 'organization.branch.create' },
          {
            id: 'branch-manage',
            ...
            requiredGrant: 'organization.branch.view',
          },
          { id: 'branch-edit', path: '/app/admin/org-structure/branches/edit', labelKey: 'adminDomains.orgStructure.branchEdit', implementation: 'org-branch-edit', nav: 'hidden', requiredGrant: 'organization.branch.update' },
          { id: 'branch-disable', path: '/app/admin/org-structure/branches/disable', labelKey: 'adminDomains.orgStructure.branchDisable', implementation: 'org-branch-disable', nav: 'hidden', requiredGrant: 'organization.branch.update' },
          { id: 'branch-dept', path: '/app/admin/org-structure/branches/departments', labelKey: 'adminDomains.orgStructure.branchDept', implementation: 'org-branch-dept', nav: 'hidden', requiredGrant: 'organization.branch.update' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
        ...
        items: [
          {
            ...
            requiredGrant: 'system.permission_group.view',
          },
          {
            id: 'master-data',
            ...
            requiredGrant: 'organization.master_data.view',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            requiredGrant: 'organization.position.view',
          },
          {
            id: 'pos-manage',
          ...
          { id: 'pos-assign', path: '/app/admin/rbac/positions/assign', labelKey: 'adminDomains.rbac.posAssign', implementation: 'rbac-pos-assign', nav: 'hidden', requiredGrant: 'organization.employee.update' },
          { id: 'pos-edit', path: '/app/admin/rbac/positions/edit', labelKey: 'adminDomains.rbac.posEdit', implementation: 'rbac-pos-edit', nav: 'hidden', requiredGrant: 'organization.position.update' },
          { id: 'pos-disable', path: '/app/admin/rbac/positions/disable', labelKey: 'adminDomains.rbac.posDisable', implementation: 'rbac-pos-disable', nav: 'hidden', requiredGrant: 'organization.position.update' },
        ],
      },
      {
        id: 'orgRoles',
        ...
        items: [
          {
            ...
            requiredGrant: 'organization.organization_role.view',
          },
          {
            id: 'org-role-create',
            ...
            requiredGrant: 'organization.organization_role.update',
          },
          {
          ...
          { id: 'org-role-edit', path: '/app/admin/rbac/org-roles/edit', labelKey: 'adminDomains.rbac.orgRoleEdit', implementation: 'rbac-org-role-edit', nav: 'hidden', requiredGrant: 'organization.organization_role.update' },
          { id: 'org-role-assign', path: '/app/admin/rbac/org-roles/assign', labelKey: 'adminDomains.rbac.orgRoleAssign', implementation: 'rbac-org-role-assign', nav: 'hidden', requiredGrant: 'organization.organization_role.update' },
          { id: 'org-role-delete', path: '/app/admin/rbac/org-roles/delete', labelKey: 'adminDomains.rbac.orgRoleDelete', implementation: 'rbac-org-role-delete', nav: 'hidden', requiredGrant: 'organization.organization_role.update' },
        ],
      },
      {
        id: 'projectRoles',
      ...
      },
      {
        ...
        items: [
          { id: 'roles', path: '/app/admin/rbac/roles', labelKey: 'adminDomains.rbac.roles', implementation: 'rbac-list', requiredGrant: 'system.permission_group.view' },
          { id: 'create', path: '/app/admin/rbac/create', labelKey: 'adminDomains.rbac.create', implementation: 'rbac-create', requiredGrant: 'system.permission_group.clone' },
          { id: 'permissions', path: '/app/admin/rbac/permissions', labelKey: 'adminDomains.rbac.permissions', implementation: 'rbac-permissions', requiredGrant: 'system.permission_group.update_grant' },
          { id: 'hierarchy', path: '/app/admin/rbac/hierarchy', labelKey: 'adminDomains.rbac.hierarchy', implementation: 'rbac-hierarchy', requiredGrant: 'system.permission_group.view' },
          { id: 'matrix', path: '/app/admin/rbac/matrix', labelKey: 'adminDomains.rbac.matrix', implementation: 'rbac-matrix', requiredGrant: 'system.permission_group.view' },
          {
            id: 'perm-pack-manage',
          ...
          { id: 'assign', path: '/app/admin/rbac/assign', labelKey: 'adminDomains.rbac.assign', implementation: 'rbac-assign', nav: 'hidden', requiredGrant: 'system.permission_group.assign' },
          { id: 'revoke', path: '/app/admin/rbac/revoke', labelKey: 'adminDomains.rbac.revoke', implementation: 'rbac-revoke', nav: 'hidden', requiredGrant: 'system.permission_group.assign' },
          { id: 'delete', path: '/app/admin/rbac/delete', labelKey: 'adminDomains.rbac.delete', implementation: 'rbac-delete', nav: 'hidden', requiredGrant: 'system.permission_group.clone' },
          {
            id: 'edit',
            ...
            nav: 'hidden',
            requiredGrant: 'system.permission_group.rename',
          },
        ],
      },
    ],
    ...
    sections: [
      {
        id: 'main',
        items: [
          { id: 'list', path: '/app/admin/channels', labelKey: 'adminDomains.channels.list', end: true, implementation: 'channels-list', requiredGrant: 'communication.channel.view' },
          {
            id: 'channel-manage',
            path: '/app/admin/channels/manage',
            labelKey: 'adminDomains.channels.manageHub',
            implementation: 'channels-manage',
            requiredGrant: 'communication.channel.update',
          },
          {
            id: 'edit',
