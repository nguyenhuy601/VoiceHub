...
export const wizardUi = {
  ...
  statusCard:
    'w-full rounded-xl border border-border bg-card p-4 text-left transition hover:bg-muted/40',
  statusCardActive:
    'w-full rounded-xl border border-primary bg-primary/10 p-4 text-left ring-1 ring-primary/40',
  sampleRow:
