...
const ACTION_LINKS = [
  { tab: 'edit', labelKey: 'adminDomains.channels.edit' },
  { tab: 'members', labelKey: 'adminDomains.channels.members' },
  { tab: 'visibility', labelKey: 'adminDomains.channels.visibility' },
  { tab: 'transfer', labelKey: 'adminDomains.channels.transfer' },
  { tab: 'archive', labelKey: 'adminDomains.channels.archive' },
  { tab: 'restore', labelKey: 'adminDomains.channels.restore' },
];
